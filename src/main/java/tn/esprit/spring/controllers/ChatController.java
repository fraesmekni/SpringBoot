...
import tn.esprit.spring.configuration.ChatBotConfiguration;
...
public class ChatController {
    ...
    public String detectIntentAudio(String projectId, byte[] inputAudio, String sessionId, String languageCode) {
        ...
        try (SessionsClient sessionsClient = SessionsClient.create()) {
            ...
            DetectIntentRequest request = DetectIntentRequest.newBuilder().setSession(String.valueOf(session))
